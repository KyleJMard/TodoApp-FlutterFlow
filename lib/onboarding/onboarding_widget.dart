          ...
          child: Container(
            ...
            child: Stack(
              children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: Image.asset(
                              'assets/images/ToDoListOnboardBgr.png',
                            ).image,
                          ),
                        ),
                        child: Padding(
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    filled: true,
                                    fillColor: Color(0xFF020000),
                                    suffixIcon: _model.nameTextController1!.text
                                            .isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.nameTextController1
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    filled: true,
                                    fillColor: Color(0xFF020000),
                                    suffixIcon: _model.nameTextController2!.text
                                            .isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.nameTextController2
                      ...
                      child: Stack(
                        children: [
                          Align(
                            ...
                            child: Container(
                              key:
                                  ValueKey(_model.uploadedFileUrl_profilePhoto),
                              width: 109.66,
                              height: 126.4,
                              decoration: BoxDecoration(
                                image: DecorationImage(
                ...
                Align(
                  alignment: AlignmentDirectional(0.01, 0.53),
                  child: Padding(
                    padding:
