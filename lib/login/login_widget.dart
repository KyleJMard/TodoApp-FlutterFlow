...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signUpCnfrmPassTextController ??= TextEditingController();
    _model.signUpCnfrmPassFocusNode ??= FocusNode();
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                Container(
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: Image.asset(
                        'assets/images/ToDoAppBgrnd.png',
                      ).image,
                    ),
                                                  ...
                                                  children: [
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .signUpCnfrmPassTextController,
                                                          focusNode: _model
                                                              .signUpCnfrmPassFocusNode,
                                                          autofocus: false,
                                                          textInputAction:
                                                              TextInputAction
                                                                  .done,
                                                          obscureText: !_model
                                                              .signUpCnfrmPassVisibility,
                                                          decoration:
                                                              InputDecoration(
                                                            isDense: false,
                                                            alignLabelWithHint:
                                                            ...
                                                            suffixIcon: InkWell(
                                                              ...
                                                              focusNode: FocusNode(
                                                                  skipTraversal:
                                                                      true),
                                                              child: Icon(
                                                                _model.signUpCnfrmPassVisibility
                                                                    ? Icons
                                                                        .visibility_outlined
                                                                    : Icons
                                                                        .visibility_off_outlined,
                                                          ...
                                                          enableInteractiveSelection:
                                                              true,
                                                          validator: _model
                                                              .signUpCnfrmPassTextControllerValidator
                                                              .asValidator(
                                                                  context),
                                                        ),
                                                      ),
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.signUpPasswordTextController
                                            .text !=
                                        _model.signUpCnfrmPassTextController
                                            .text) {
                ...
                Align(
                  alignment: AlignmentDirectional(-0.26, -0.78),
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(24.0),
                    child: Image.asset(
                      'assets/images/KylesToDoAppLogoFinal.png',
                      width: 107.32,
                      height: 100.7,
                      fit: BoxFit.contain,
