...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  // State field(s) for SignUpCnfrmPass widget.
  FocusNode? signUpCnfrmPassFocusNode;
  TextEditingController? signUpCnfrmPassTextController;
  late bool signUpCnfrmPassVisibility;
  String? Function(BuildContext, String?)?
      signUpCnfrmPassTextControllerValidator;
  String? _signUpCnfrmPassTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
  ...
  void initState(BuildContext context) {
    ...
    signUpCnfrmPassVisibility = false;
    signUpCnfrmPassTextControllerValidator =
        _signUpCnfrmPassTextControllerValidator;
  ...
  void dispose() {
    ...
    signUpCnfrmPassFocusNode?.dispose();
    signUpCnfrmPassTextController?.dispose();
